...
import static com.war.wechat.base.util.BeanUtil.isNull;
import static com.war.wechat.base.util.BeanUtil.nonNull;
import static com.war.wechat.base.util.CollectionUtil.isEmpty;
import static com.war.wechat.base.util.CollectionUtil.isNotEmpty;
import static com.war.wechat.base.util.StrUtil.isNotBlank;
...
import com.war.wechat.base.handle.EventHandle;
import com.war.wechat.base.handle.MessageHandle;
import com.war.wechat.base.message.BaseMsg;
import com.war.wechat.base.message.TextMsg;
import com.war.wechat.base.message.aes.AesException;
import com.war.wechat.base.message.aes.WXBizMsgCrypt;
import com.war.wechat.base.message.req.BaseEvent;
import com.war.wechat.base.message.req.BaseReq;
import com.war.wechat.base.message.req.BaseReqMsg;
import com.war.wechat.base.message.req.EventType;
import com.war.wechat.base.message.req.ImageReqMsg;
import com.war.wechat.base.message.req.LinkReqMsg;
import com.war.wechat.base.message.req.LocationEvent;
import com.war.wechat.base.message.req.LocationReqMsg;
import com.war.wechat.base.message.req.MenuEvent;
import com.war.wechat.base.message.req.QrCodeEvent;
import com.war.wechat.base.message.req.ReqType;
import com.war.wechat.base.message.req.TextReqMsg;
import com.war.wechat.base.message.req.VideoReqMsg;
import com.war.wechat.base.message.req.VoiceReqMsg;
import com.war.wechat.base.util.MessageUtil;
import com.war.wechat.base.util.SignUtil;
import com.war.wechat.base.util.StrUtil;
...
public abstract class WeixinServletSupport extends HttpServlet {
    ...
    protected final void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        if (isLegal(request)) {
    		...
    		try {
    			...
    			WXBizMsgCrypt wxcpt = new WXBizMsgCrypt(getToken(),getAESKey(), getAppId());
    			str = wxcpt.verifyUrl(signature, timestamp, nonce, echostr);
    ...
    protected final void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	//将当前用户放入session 此处不能取fromUserName 否则下面会解析不到
    	//request.getSession().setAttribute(WeChatConst.WECHAT_USER_KEY, request.getParameter(WeChatConst.WECHAT_USER_KEY));
    ...
    private String processRequest(HttpServletRequest request) {
        ...
        if (msgType.equals(ReqType.EVENT)) {
            ...
            if (eventType.equalsIgnoreCase(EventType.SUBSCRIBE)) {
            ...
            } else if (eventType.equalsIgnoreCase(EventType.UNSUBSCRIBE)) {
                BaseEvent event = new BaseEvent();
                buildBasicEvent(reqMap, event);
            ...
            } else if (eventType.equalsIgnoreCase(EventType.CLICK)) {
                String eventKey = reqMap.get("EventKey");
            ...
            } else if (eventType.equalsIgnoreCase(EventType.VIEW)) {
                String eventKey = reqMap.get("EventKey");
                MenuEvent event = new MenuEvent(eventKey);
                buildBasicEvent(reqMap, event);
            ...
            } else if (eventType.equalsIgnoreCase(EventType.LOCATION)) {
            ...
            if (msgType.equalsIgnoreCase(ReqType.TEXT)) {
            ...
            } else if (msgType.equalsIgnoreCase(ReqType.IMAGE)) {
            ...
            } else if (msgType.equalsIgnoreCase(ReqType.VOICE)) {
            ...
            } else if (msgType.equalsIgnoreCase(ReqType.VIDEO)) {
            ...
            } else if (msgType.equalsIgnoreCase(ReqType.LOCATION)) {
            ...
            } else if (msgType.equalsIgnoreCase(ReqType.LINK)) {
    ...
    private boolean isLegal(HttpServletRequest request) {
        ...
        return SignUtil.checkSignature(getToken(), signature,echostr, timestamp, nonce);
    }
}