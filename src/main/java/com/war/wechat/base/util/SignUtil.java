package com.war.wechat.base.util;
...
import static com.war.wechat.base.util.StrUtil.isHasBlank;
...
public final class SignUtil {
     ...
     * @return 是否合法
     */
    public static boolean checkSignature(String token, String signature,String echostr,
                                         String timestamp, String nonce) {
        if (isHasBlank(token, echostr, timestamp, nonce)) {
            return false;
        }
