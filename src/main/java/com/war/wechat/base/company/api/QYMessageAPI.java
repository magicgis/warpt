...
import com.war.wechat.base.api.BaseAPI;
...
import com.war.wechat.base.company.api.response.GetQYSendMessageResponse;
import com.war.wechat.base.company.message.*;
...
public class QYMessageAPI extends QYBaseAPI {
    ...
    public GetQYSendMessageResponse send(QYBaseMsg message){
        ...
        if(message instanceof QYTextMsg){
           ...
           // System.out.println("json:" + JSONUtil.toJson((QYNewsMsg)message));
        }
