...
public class VipUserBaseService extends CrudService<VipUserBaseDao, VipUserBase> {
	@Autowired
	...
	public Page<VipUserBase> findPage(Page<VipUserBase> page, VipUserBase vipUserBase) {
	...
	public void save(VipUserBase vipUserBase) {
		...
		if (isNewRecord) { // 新增初始化钱包
			...
			if (!StringUtils.equals(vipUserBase.getLevelName(), "一级代理")
				...
				MessageUtil.getInterface().send("REGISTER_CODE", vipUserBase.getVipPhone(), contentMap);
			}
		}
