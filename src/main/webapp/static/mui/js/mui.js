/*!
 * =====================================================
 * Mui v3.2.0 (http://dev.dcloud.net.cn/mui)-部分定制swb
 * =====================================================
 */
/**
 * MUI核心JS
...
(function($, window, document) {
	...
	window.addEventListener('tap', function(event) {
		...
		if (classList.contains('mui-collapse') && !cell.parentNode.classList.contains('mui-unfold')) {
			...
			//swb update 新增my-self样式，控制面板动作时候不控制其他面板
			if (!classList.contains(CLASS_ACTIVE) && !cell.classList.contains('my-self')) { //展开时,需要收缩其他同类
