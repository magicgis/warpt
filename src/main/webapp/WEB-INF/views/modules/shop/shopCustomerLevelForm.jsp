...
<body>
	...
	<form:form id="inputForm" modelAttribute="shopCustomerLevel" action="${ctx}/shop/shopCustomerLevel/save" method="post" class="form-horizontal">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="levelName" htmlEscape="false" maxlength="200" class="required"/>
		...
		<div class="form-actions">
			<shiro:hasPermission name="shop:shopCustomerLevel:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
