...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/shop/shopCustomerInfo/">销售客户列表</a></li>
		<li class="active"><a href="${ctx}/shop/shopCustomerInfo/form?id=${shopCustomerInfo.id}">销售客户<shiro:hasPermission name="shop:shopCustomerInfo:edit">${not empty shopCustomerInfo.id?'修改':'添加'}</shiro:hasPermission><shiro:lacksPermission name="shop:shopCustomerInfo:edit">查看</shiro:lacksPermission></a></li>
	</ul><br/>
	<form:form id="inputForm" modelAttribute="shopCustomerInfo" action="${ctx}/shop/shopCustomerInfo/save" method="post" class="form-horizontal">
		...
		<div class="form-actions">
			<shiro:hasPermission name="shop:shopCustomerInfo:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
