			...
			<el-button v-if="!isSaveFn" type="primary" icon="el-icon-check" disabled="true">采购入库</el-button>
		 	...
		 	<el-row type="flex">
			  ...
			  <el-form-item label="供应商">
			  	<el-col :span="16">
			    <el-select v-if="isAddView" v-model="addForm.supplierId" placeholder="请选择供应商" @change="selectSupplierObj()">
			      <el-option v-for="(item, index) in supplierList" v-bind:label="item.supplierName" v-bind:value="item.id"></el-option>
			    </el-select>
			    <el-select v-if="!isAddView" disabled v-model="addForm.supplierId" placeholder="请选择供应商" @change="selectSupplierObj()">
			      <el-option v-for="(item, index) in supplierList" v-bind:label="item.supplierName" v-bind:value="item.id"></el-option>
			    </el-select>
			    </el-col>
			  </el-form-item>
