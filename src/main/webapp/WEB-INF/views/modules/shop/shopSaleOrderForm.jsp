...
<body>
	...
	<template>
		...
		<el-col :span="2">
			<el-button v-if="isSaveFn" type="primary" icon="el-icon-check" @click="submitInfo" v-loading.fullscreen.lock="fullscreenLoading">销售出库</el-button>
			<el-button v-if="!isSaveFn" type="primary" icon="el-icon-check" disabled="true">销售出库</el-button>
		</el-col>
		</el-row>
		 	<el-row type="flex">
		 	  <el-col :span="6">
			  ...
			  <el-col :span="6">
			  <el-form-item label="销售日期" prop="businData">
			  	<el-col :span="16">
				  ...
				  <el-form-item label="账目类型" >
				  	<el-col :span="16">
					    <el-select  v-if="isAddView" v-model="addForm.subjectType" placeholder="请选择">
				      		<el-option label="销售出货" value="1000"></el-option>
				      		<el-option label="销售退货" value="1001"></el-option>
				    	</el-select>
			 ...
			 <el-row type="flex">
				<el-table
				    :data="addForm.shopSaleOrderItemList"
				    border
				    ...
				    <el-table-column
				      ...
				      width="100">
					      ...
					      <span v-if="isAddView" style="width:120px;">
					      	<el-input type='text' v-model="scope.row.saleNum" @change="changeSetRow(scope.$index)"></el-input>
					      </span>
					      <span v-if="!isAddView">{{scope.row.saleNum}}</span>
					      </template>
				    </el-table-column>
				    <el-table-column
				      label="当前库存"
					...
					<el-table-column
				        ...
				        width="100">
					      ...
					      <span v-if="isAddView" style="width:80px;">
					      	<el-input type='text' v-model="scope.row.saleMoney" @change="changeSetRow(scope.$index)"></el-input>
					      </span>
					      <span v-if="!isAddView">{{scope.row.saleMoney}}</span>
					      </template>
				    </el-table-column>
					<el-table-column
						align="center"
	...
	<script src="${ctxStatic}/modules/shop/shopSaleOrderForm.js" type="text/javascript"></script>
</html>