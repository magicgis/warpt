...
<body>
	<ul class="nav nav-tabs">
		<li><a href="${ctx}/shop/shopReport/saleReportList">销售明细</a></li>
		<li><a href="${ctx}/shop/shopReport/saleProductSumReport">按商品汇总</a></li>
		<li class="active"><a href="${ctx}/shop/shopReport/saleCustomerSumReport">按客户汇总</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="shopSaleOrderItem" action="${ctx}/shop/shopReport/saleCustomerSumReport" method="post" class="breadcrumb form-search">
	...
	<table id="contentTable" class="table table-striped table-bordered table-condensed">
		...
		<c:forEach items="${page.list}" var="shopSaleOrderItem">
			<tr>
				...
				<td>
					${shopSaleOrderItem.sumProfit}
				</td>
				<td>
					${shopSaleOrderItem.percentage}
				</td>
			</tr>
		</c:forEach>
		</tbody>
