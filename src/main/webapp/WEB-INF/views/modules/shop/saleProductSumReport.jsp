...
<body>
	<ul class="nav nav-tabs">
		...
		<li class="active"><a href="${ctx}/shop/shopReport/saleProductSumReport">按商品汇总</a></li>
		<li><a href="${ctx}/shop/shopReport/saleCustomerSumReport">按客户汇总</a></li>
	</ul>
	<form:form id="searchForm" modelAttribute="shopSaleOrderItem" action="${ctx}/shop/shopReport/saleProductSumReport" method="post" class="breadcrumb form-search">
