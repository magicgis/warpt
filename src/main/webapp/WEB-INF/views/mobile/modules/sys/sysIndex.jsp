...
<section id="index_section">
    ...
    <script type="text/javascript">
   		...
   		$('#purchaseOrder').tap(function(){
   			window.location.href = "${ctx}/xy/purchaseOrder/listApp";
   		});
   		$('#saleOrder').tap(function(){
   			window.location.href = "${ctx}/xy/saleOrder/listApp";
   		});
   		$('#diffOrder').tap(function(){
   			window.location.href = "${ctx}/xy/difference/listApp";
   		});    		
    </script>
</section>